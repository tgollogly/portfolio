...
export const FUEL_LEGAL_NOTICE = {
  ...
  sections: [
    ...
    },
    {
      heading: "Music & ABBA",
      text:
        "This site does not host, copy, or stream ABBA recordings from our servers. Any ABBA playback uses official YouTube and Spotify players (their licences and terms apply). An optional 'Fuel melody' button plays a short original chime we composed — it is not an ABBA song. Confirm prices by phone; music is entertainment only.",
    },
    {
      heading: "Liability",
      text:
