...
export const FUEL_LEGAL_NOTICE = {
  ...
  sections: [
    ...
    },
    {
      heading: "Music & ABBA",
      text:
        "This site does not host, copy, or stream ABBA recordings from our servers. Any ABBA playback uses Spotify’s official player (their licence and terms apply). An optional 'Original chime' button plays a short original melody we composed — it is not an ABBA song. Confirm prices by phone; music is entertainment only.",
    },
    {
      heading: "Liability",
      text:
